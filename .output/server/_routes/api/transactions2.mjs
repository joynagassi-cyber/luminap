import { g as readBody, l as createError, u as defineHandler } from "../../_libs/h3+rou3+srvx.mjs";
...
var transactions_post_default = defineHandler(async (event) => {
	...
	if (!type || !amount || !description || !date || !categoryId || !status) throw createError({
		statusCode: 400,
		statusMessage: "Missing required fields"
	});
	const sanitizedDescription = typeof description === "string" ? description.replace(/</g, "&lt;").replace(/>/g, "&gt;") : String(description);
	const newTx = {
		id: `tx-${Date.now()}`,
		orgId: "org-1",
		type,
