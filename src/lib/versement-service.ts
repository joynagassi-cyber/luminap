 ...
 */
export async function createVersement(
  params: CreateVersementParams,
): Promise<VersementResult> {
  ...
  const comment =
    params.comment ||
    `Versement ${Math.round(params.amount / 100)} FCFA -> Caisse principale`;
  ...
  try {
    await executeWrite(
      ...
      [
        ...
        sourceTx.comment,
        sourceTx.version,
        sourceTx.sourceCaisseId,
        sourceTx.versementId,
        sourceTx.reversalOfId,
        sourceTx.createdById,
        sourceTx.approvedById,
        sourceTx.createdAt,
        sourceTx.updatedAt,
        sourceTx.approvedAt,
      ],
    ...
    await executeWrite(
      ...
      [
        ...
        targetTx.comment,
        targetTx.version,
        targetTx.sourceCaisseId,
        targetTx.versementId,
        targetTx.reversalOfId,
        targetTx.createdById,
        targetTx.approvedById,
        targetTx.createdAt,
        targetTx.updatedAt,
        targetTx.approvedAt,
      ],
