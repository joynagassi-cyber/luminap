  ...
  const roles = [
    {
      id: "TREASURIER",
      label: "Trésorier",
      desc: "Gestion complète des finances",
      icon: Wallet,
      iconColor: "#1DB954",
    },
    {
      id: "PASTEUR",
      label: "Pasteur",
      desc: "Vue d'ensemble et validation",
      icon: Church,
      iconColor: "#FF6B00",
    },
    {
    ...
    },
    {
      id: "COMPTABLE",
      label: "Comptable",
      desc: "Bilans et grand livre",
      icon: BarChart3,
      iconColor: "#3B82F6",
    },
    {
      id: "TREASURIER_ADJOINT",
      label: "Trésorier Adjoint",
      desc: "Assistance trésorerie",
      icon: Banknote,
      iconColor: "#14B8A6",
    },
    {
          ...
          <div className="flex-1 px-6 pb-24 pt-2">
            <div className="max-w-sm mx-auto">
              ...
              <p className="text-[#808080] text-sm mb-6">
                Cela déterminera vos permissions dans l'application.
              </p>
