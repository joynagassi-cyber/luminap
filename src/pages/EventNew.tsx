...
import { IonPage, IonHeader, IonContent, IonTitle, IonToolbar, IonButtons, IonBackButton, IonInput, IonButton } from '@ionic/react';
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1">
                  ...
                  <IonInput
                    ...
                    onIonChange={(e) => setMontantCotisation((e.detail.value as string) ?? '')}
                    min="0"
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex gap-2">
                  <IonInput
                    ...
                    onIonChange={(e) => setNewBudgetLabel((e.detail.value as string) ?? '')}
                    placeholder="Poste"
                  ...
                  <IonInput
                    ...
                    onIonChange={(e) => setNewBudgetAmount((e.detail.value as string) ?? '')}
                    placeholder="Montant"
                    style={{ backgroundColor: '#181818', color: '#fff', border: '1px solid #282828' }}
                  />
                  <button
