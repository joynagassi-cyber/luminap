...
export default function EventEdit() {
  ...
  const { events: idbEvents, categories: idbCategories, updateEvent, isLoading } = useLocalStore();
    ...
    <div className="min-h-screen bg-canvas">
      ...
      <div className="max-w-lg mx-auto px-5 pb-32 pt-16">
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="text-text-tertiary text-xs mb-2 block">Date de fin</label>
            <input
              type="date"
              value={endDate}
