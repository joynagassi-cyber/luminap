    ...
    <div className="min-h-screen bg-canvas">
      <div className="max-w-lg mx-auto px-5 pt-4 pb-4">
        ...
        <div className="mb-6">
          ...
          <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Décrivez la transaction..." maxLength={500} className="w-full px-4 py-3 rounded-lg text-text-primary text-sm outline-none resize-none" style={{ backgroundColor: '#181818', border: '1px solid #282828', minHeight: '80px' }} rows={3} />
        </div>

        {/* Buttons */}
        <div className="flex gap-3 mb-6">
          <button onClick={() => handleSubmit('DRAFT')} className="flex-1 py-3.5 rounded-full text-sm font-semibold" style={{ backgroundColor: '#181818', color: '#B3B3B3' }}>Enregistrer</button>
