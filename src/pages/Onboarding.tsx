...
const SCREENS = [
  {
    ...
    description:
      "Suivez les revenus, dépenses et versements de votre église — offline, sécurisé et accessible à tous.",
    illustration: (
      <svg
        viewBox="0 0 280 200"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Créez des transactions en quelques taps. Suivez leur statut : brouillon, en attente, approuvé ou rejeté. Chaque action est tracée.",
    illustration: (
      <svg
        viewBox="0 0 280 200"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Chaque groupe (Diacres, Jeunesse, Dames...) a sa propre caisse. Effectuez des versements vers la caisse principale en toute simplicité.",
    illustration: (
      <svg
        viewBox="0 0 280 200"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Créez des événements avec budget détaillé. Suivez les dépenses en temps réel et gérez la liste des achats pour chaque célébration.",
    illustration: (
      <svg
        viewBox="0 0 280 200"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Générez des bilans financiers par période. Exportez en PDF, Excel ou CSV avec le logo et le nom de votre église.",
    illustration: (
      <svg
        viewBox="0 0 280 200"
        fill="none"
